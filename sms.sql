...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2020 at 05:30 PM
...
CREATE TABLE `student_info` (
  ...
  `std_img` text DEFAULT 'default.png',
...
INSERT INTO `student_info` (`id`, `std_group`, `shift`, `class`, `std_name`, `ftr_name`, `mtr_name`, `birth_date`, `gender`, `nationality`, `religion`, `care_of`, `address`, `district`, `upazila`, `post_office`, `post_code`, `ftr_number`, `std_number`, `std_email`, `psc_xm_type`, `psc_board`, `psc_roll`, `psc_passing_yr`, `jsc_xm_type`, `jsc_board`, `jsc_roll`, `jsc_passing_yr`, `admission_date`, `std_img`, `std_pass`) VALUES
(202100001, 'Sceience', 'Morning', 'six', 'Amanullah Aman', 'Ruhul Amin', 'Sanuara Amin', '1996-06-25', 'Male', 'Bangladeshi', 'Islam', 'Ruhul Amin', 'kansat', 'Chapainawabganj', 'Shibganj', 'Chatra', '6341', '01718949510', '01756007000', 'amanullah.bcse@gamil.com', 'psc', 'Rajshahi', '102030', '2008', 'jsc', 'Rajshahi', '405060', '2011', '19-09-20', '118807708_317468025980032_2581785731367286770_n.jpg', '123456');
...
INSERT INTO `teacher_info` (`id`, `t_name`, `t_pass`, `t_email`, `t_designation`, `t_qualification`, `t_gender`, `t_address`, `t_contact`, `t_img`) VALUES
(124506001, 'Abir', '123456', 'amanullah.bcse@gmail.com', 'Head Teacher', 'M.Sc.', 'Male', 'dhaka', '01775251044', '117310085_333825074458980_4635301757464392111_n.jpg');
...
--
ALTER TABLE `admission_admin`
  MODIFY `a_a_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `routine`
  MODIFY `rtn_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
